...
-- ============================================================================
-- 1. REGISTRO DE LLAVES CRIPTOGRÁFICAS (AuthenticationSubscription)
-- Creamos 4 IMSIs secuenciales usando el PLMN 208-95 (Emparejado con los simuladores)
-- ============================================================================

-- UE para Slice 1 (eMBB) - IMSI: 208950000000001
INSERT INTO `AuthenticationSubscription` (`ueid`, `authenticationMethod`, `encPermanentKey`, `protectionParameterId`, `sequenceNumber`, `authenticationManagementField`, `algorithmId`, `encOpcKey`, `encTopcKey`, `vectorGenerationInHss`, `n5gcAuthMethod`, `rgAuthenticationInd`, `supi`) VALUES
('208950000000001', '5G_AKA', 'fee50c25709fb1d246671874391e29d5', 'fee50c25709fb1d246671874391e29d5', '{"sqn": "000000000020", "sqnScheme": "NON_TIME_BASED", "lastIndexes": {"ausf": 0}}', '8000', 'milenage', '073a59c280a31d4385428841ea0a6bc3', NULL, NULL, NULL, NULL, '208950000000001');

-- UE para Slice 2 (URLLC) - IMSI: 208950000000002
INSERT INTO `AuthenticationSubscription` (`ueid`, `authenticationMethod`, `encPermanentKey`, `protectionParameterId`, `sequenceNumber`, `authenticationManagementField`, `algorithmId`, `encOpcKey`, `encTopcKey`, `vectorGenerationInHss`, `n5gcAuthMethod`, `rgAuthenticationInd`, `supi`) VALUES
('208950000000002', '5G_AKA', 'fee50c25709fb1d246671874391e29d5', 'fee50c25709fb1d246671874391e29d5', '{"sqn": "000000000020", "sqnScheme": "NON_TIME_BASED", "lastIndexes": {"ausf": 0}}', '8000', 'milenage', '073a59c280a31d4385428841ea0a6bc3', NULL, NULL, NULL, NULL, '208950000000002');

-- UE para Slice 3 (mMTC) - IMSI: 208950000000003
INSERT INTO `AuthenticationSubscription` (`ueid`, `authenticationMethod`, `encPermanentKey`, `protectionParameterId`, `sequenceNumber`, `authenticationManagementField`, `algorithmId`, `encOpcKey`, `encTopcKey`, `vectorGenerationInHss`, `n5gcAuthMethod`, `rgAuthenticationInd`, `supi`) VALUES
('208950000000003', '5G_AKA', 'fee50c25709fb1d246671874391e29d5', 'fee50c25709fb1d246671874391e29d5', '{"sqn": "000000000020", "sqnScheme": "NON_TIME_BASED", "lastIndexes": {"ausf": 0}}', '8000', 'milenage', '073a59c280a31d4385428841ea0a6bc3', NULL, NULL, NULL, NULL, '208950000000003');

-- UE para Slice 4 (V2X) - IMSI: 208950000000004
INSERT INTO `AuthenticationSubscription` (`ueid`, `authenticationMethod`, `encPermanentKey`, `protectionParameterId`, `sequenceNumber`, `authenticationManagementField`, `algorithmId`, `encOpcKey`, `encTopcKey`, `vectorGenerationInHss`, `n5gcAuthMethod`, `rgAuthenticationInd`, `supi`) VALUES
('208950000000004', '5G_AKA', 'fee50c25709fb1d246671874391e29d5', 'fee50c25709fb1d246671874391e29d5', '{"sqn": "000000000020", "sqnScheme": "NON_TIME_BASED", "lastIndexes": {"ausf": 0}}', '8000', 'milenage', '073a59c280a31d4385428841ea0a6bc3', NULL, NULL, NULL, NULL, '208950000000004');


-- ============================================================================
-- 2. ASIGNACIÓN DE SLICES Y DATOS DE SESIÓN (SessionManagementSubscriptionData)
-- Vinculamos cada IMSI a su respectivo par SST / SD y red de datos (DNN "oai")
-- ============================================================================

-- Configuración para UE 1 -> Slice 1 (SST: 1, SD: 000001)
INSERT INTO `SessionManagementSubscriptionData` (`ueid`, `servingPlmnid`, `singleNssai`, `dnnConfigurations`) VALUES
('208950000000001', '20895', '{"sst": 1, "sd": "000001"}','{"oai":{"pduSessionTypes":{ "defaultSessionType": "IPV4"},"sscModes": {"defaultSscMode": "SSC_MODE_1"},"5gQosProfile": {"5qi": 6,"arp":{"priorityLevel": 1,"preemptCap": "NOT_PREEMPT","preemptVuln":"PREEMPTABLE"},"priorityLevel":1},"sessionAmbr":{"uplink":"330Mbps", "downlink":"330Mbps"}}}');

-- Configuración para UE 2 -> Slice 2 (SST: 2, SD: 000002)
INSERT INTO `SessionManagementSubscriptionData` (`ueid`, `servingPlmnid`, `singleNssai`, `dnnConfigurations`) VALUES
('208950000000002', '20895', '{"sst": 2, "sd": "000002"}','{"oai":{"pduSessionTypes":{ "defaultSessionType": "IPV4"},"sscModes": {"defaultSscMode": "SSC_MODE_1"},"5gQosProfile": {"5qi": 1,"arp":{"priorityLevel": 15,"preemptCap": "NOT_PREEMPT","preemptVuln":"PREEMPTABLE"},"priorityLevel":1},"sessionAmbr":{"uplink":"1000Mbps", "downlink":"1000Mbps"}}}');

-- Configuración para UE 3 -> Slice 3 (SST: 3, SD: 000003)
INSERT INTO `SessionManagementSubscriptionData` (`ueid`, `servingPlmnid`, `singleNssai`, `dnnConfigurations`) VALUES
('208950000000003', '20895', '{"sst": 3, "sd": "000003"}','{"oai":{"pduSessionTypes":{ "defaultSessionType": "IPV4"},"sscModes": {"defaultSscMode": "SSC_MODE_1"},"5gQosProfile": {"5qi": 9,"arp":{"priorityLevel": 5,"preemptCap": "NOT_PREEMPT","preemptVuln":"PREEMPTABLE"},"priorityLevel":2},"sessionAmbr":{"uplink":"10Mbps", "downlink":"10Mbps"}}}');

-- Configuración para UE 4 -> Slice 4 (SST: 4, SD: 000004)
INSERT INTO `SessionManagementSubscriptionData` (`ueid`, `servingPlmnid`, `singleNssai`, `dnnConfigurations`) VALUES
('208950000000004', '20895', '{"sst": 4, "sd": "000004"}','{"oai":{"pduSessionTypes":{ "defaultSessionType": "IPV4"},"sscModes": {"defaultSscMode": "SSC_MODE_1"},"5gQosProfile": {"5qi": 2,"arp":{"priorityLevel": 10,"preemptCap": "NOT_PREEMPT","preemptVuln":"PREEMPTABLE"},"priorityLevel":1},"sessionAmbr":{"uplink":"500Mbps", "downlink":"500Mbps"}}}');

-- Registro de suscripción AccessAndMobilitySubscriptionData para los 4 UEs/Slices
INSERT INTO `AccessAndMobilitySubscriptionData` (`ueid`, `servingPlmnid`, `nssai`) VALUES
('208950000000001', '20895', '{"defaultSingleNssais": [{"sst": 1, "sd": "000001"}]}'),
('208950000000002', '20895', '{"defaultSingleNssais": [{"sst": 2, "sd": "000002"}]}'),
('208950000000003', '20895', '{"defaultSingleNssais": [{"sst": 3, "sd": "000003"}]}'),
('208950000000004', '20895', '{"defaultSingleNssais": [{"sst": 4, "sd": "000004"}]}');
